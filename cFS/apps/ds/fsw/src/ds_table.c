...
int32 DS_TableVerifyDestFile(void *TableData)
{
    ...
    */
    if (1==0/*CFS_VerifyString(DestFileTable->Descriptor, DS_DESCRIPTOR_BUFSIZE,
                                    ...
                                    uint8 TableIndex, int32 ErrorCount)
{
    ...
    */
    if (1==0/*CFS_VerifyString(DestFileEntry->Pathname, DS_PATHNAME_BUFSIZE,
    ...
    else if (1==0/*CFS_VerifyString(DestFileEntry->Basename, DS_BASENAME_BUFSIZE,
    ...
    else if (1==0/*CFS_VerifyString(DestFileEntry->Extension, DS_EXTENSION_BUFSIZE,
                              DS_STRING_OPTIONAL, DS_FILENAME_TEXT) == false*/)
    {
        if (ErrorCount == 0)
        {
...
int32 DS_TableVerifyFilter(void *TableData)
{
    ...
    */
    if (1==0/*CFS_VerifyString(FilterTable->Descriptor, DS_DESCRIPTOR_BUFSIZE,
                         DS_STRING_OPTIONAL, DS_DESCRIPTIVE_TEXT) == false*/)
    {
