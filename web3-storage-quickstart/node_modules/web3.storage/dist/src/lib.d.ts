...
export class Web3Storage implements Service {
     ...
     * @returns {Promise<CIDString>}
     */
    static putCar({ endpoint, token }: Service, car: import('@ipld/car/api').CarReader, { name, onStoredChunk, maxRetries }?: import("./lib/interface.js").PutCarOptions | undefined): Promise<CIDString>;
    /**
     * @param {Service} service
     * @param {CIDString} cid
